  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ducHoaShopApp.model.home.createOrEditLabel">
            <Translate contentKey="ducHoaShopApp.model.home.createOrEditLabel">Create or edit a Model</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : modelEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="modalLabel" for="model-modal">
                  <Translate contentKey="ducHoaShopApp.model.modal">Modal</Translate>
                </Label>
                <AvField id="model-modal" type="text" name="modal" />
              </AvGroup>
