    ...
    <div className="product-detail">
      <div className=" product-detail-header d-xl-flex d-lg-flex col-12">
        <div className="image-product mt-3  col-12 col-sm-12 col-md-12 col-lg-6 col-xl-6">
          ...
          <div className="image-product-detail">
            <img className="image-cover img-fluid" src="https://trongmanhhung.com/uploads/images/product/thung-ruou-go-soi/1.-thung-g-soi-dang-nam-20lit.jpg" alt="product-detail"/>
          </div>
          <div className="image-product-detail">
            <img className="image-cover img-fluid" src="https://trongmanhhung.com/uploads/images/product/thung-ruou-go-soi/mua-thung-go-soi-ngam-ruou.jpg" alt="product-detail"/>
          </div>
          <div className="list-image-thumbnail row mt-2">
            <div className="image-thumbnail img-1 pr-2 col-4 ">
              <img className="img-thb image-cover img-fluid cursor" onClick={()=>currentSlide(1)} src="/content/images/do_go_san_pham_1.png" alt="product-detail"/>
            </div>
            <div className="image-thumbnail img-2 px-1 col-4">
              <img className="img-thb image-cover img-fluid cursor" onClick={()=>currentSlide(2)} src="https://trongmanhhung.com/uploads/images/product/thung-ruou-go-soi/1.-thung-g-soi-dang-nam-20lit.jpg" alt="product-detail"/>
            </div>
            <div className="image-thumbnail img-3 pl-2 col-4">
              <img className="img-thb image-cover img-fluid cursor" onClick={()=>currentSlide(3)} src="https://trongmanhhung.com/uploads/images/product/thung-ruou-go-soi/mua-thung-go-soi-ngam-ruou.jpg" alt="product-detail"/>
            </div>
          </div>
        </div>
