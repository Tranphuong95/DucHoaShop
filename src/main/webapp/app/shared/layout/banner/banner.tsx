...
export const Banner = (props) => {
  return (
    <div className=" banner d-flex justify-content-center">
      ...
      <div className="container-center col-10 d-flex">
        ...
        <div
          className="warp-cart d-block d-sm-none d-md-none d-lg-none d-xl-none d-flex d-sm-flex d-md-flex  flex-wrap align-content-center">
        ...
        <div className="commitment d-none d-sm-none d-md-none d-lg-none d-xl-block d-xl-flex">
          <div className="commitment-item d-flex flex-wrap align-content-center justify-content-between mr-3">
            ...
            <div className="commit-text">
              <div className="commit-title"><strong>THANH TOÁN</strong></div>
          ...
          <div className="commitment-item d-flex flex-wrap align-content-center justify-content-between mr-3">
            ...
            <div className="commit-text">
              <div className="commit-title"><strong>VẬN CHUYỂN</strong></div>
          ...
          <div className="commitment-item d-flex flex-wrap align-content-center justify-content-between mr-3">
            ...
            <div className="commit-text">
              <div className="commit-title"><strong>CHẤT LƯỢNG HÀNG ĐẦU</strong></div>
          ...
          <div className="commitment-item d-flex flex-wrap align-content-center justify-content-between mr-3">
            ...
            <div className="commit-text">
              <div className="commit-title"><strong>DỊCH VỤ TỐT NHẤT</strong></div>
          ...
          <div className="commitment-item d-flex flex-wrap align-content-center justify-content-between">
            ...
            <div className="commit-text">
              <div className="commit-title"><strong>GIÁ CẢ CẠNH TRANH</strong></div>
